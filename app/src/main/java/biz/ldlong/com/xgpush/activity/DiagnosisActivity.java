...
import biz.ldlong.com.xgpush.bean.ClickAction;
import biz.ldlong.com.xgpush.bean.Style;
import biz.ldlong.com.xgpush.bean.TimeInterval;
import biz.ldlong.com.xgpush.common.CommonWorkingThread;
import biz.ldlong.com.xgpush.common.ExtendedListView;
import biz.ldlong.com.xgpush.common.XingeApp;
...
public class DiagnosisActivity extends Activity implements ExtendedListView.OnPositionChangedListener {
    ...
    private void step4() {
        ...
        local_msg.setMin("10");
        local_msg.setActivity("com.qq.xgdemo.activity.SettingActivity");
    ...
    private void step7() {
        ...
        int ret_code = 0;
        try {
            biz.ldlong.com.xgpush.bean.Message message = new biz.ldlong.com.xgpush.bean.Message();
            message.setType(biz.ldlong.com.xgpush.bean.Message.TYPE_NOTIFICATION);
